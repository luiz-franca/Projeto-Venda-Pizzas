...
- **"auth/admin"**: Tela de login para administradores/funcionários.
- **"auth/customers"**: Tela de login e cadastro dedicada para clientes.
- **"auth/register"**: Tela de cadastro de funcionários/administradores.
